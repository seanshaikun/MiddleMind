...
@rt("/")
def get():
    return Nav(Li(Strong('Menu'), 
    Li(Button('News',hx_get="/page1", hx_target="#page-content"), 
       Button('Currated',hx_get='/page2',hx_target="#page-content")))),Titled('The Middle Mind Collective',A('News',hx_get="/page1", hx_target="#page-content"),
